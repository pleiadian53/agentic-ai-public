...
def send_email(recipient: str, subject: str, body: str, sender: str = None) -> dict:
    """
    Send an email (simulated). The sender can be specified or defaults to server setting.
    ...
    Args:
        ...
        sender (str, optional): The email address of the sender. 
                                If None, the server uses its default sender.
    ...
    # Only include sender in payload if explicitly provided
