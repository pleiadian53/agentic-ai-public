# Grader dependency removed for standalone development
# Original: from dlai_grader.grading import test_case, print_feedback
from types import FunctionType

# Stub implementations to replace grader functionality
class test_case:
    """Stub test case for development without grader."""
    def __init__(self):
        self.failed = False
        self.msg = ""
        self.want = None
...
def print_feedback(cases):
    """Stub feedback printer for development without grader."""
...
# ===== Neutral fixtures =====
_PROMPT = "Radio observations of extraterrestrial life"  # Change this to test different topics
_DUMMY_REPORT = (
    "This is a dummy research report about extraterrestrial life. "
