...
SERVER_DIR = Path(__file__).parent  # multiagent/research_agent/server/
RESEARCH_AGENT_DIR = SERVER_DIR.parent  # multiagent/research_agent/
MULTIAGENT_DIR = RESEARCH_AGENT_DIR.parent  # multiagent/
PROJECT_ROOT = MULTIAGENT_DIR.parent  # agentic-ai-lab/

# Key directories
OUTPUT_DIR = PROJECT_ROOT / "output" / "research_reports"
