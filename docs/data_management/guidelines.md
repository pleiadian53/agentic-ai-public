...
tool_use/ml_agent/
├── data/
│   ├── .gitignore              # Ignore *.csv, *.pkl, *.h5, etc.
│   ├── README.md               # Data catalog for this agent
│   ├── raw/
│   │   └── (gitignored data)
│   └── processed/
│       ├── tcga_processed.csv  # gitignored
│       ├── tcga_processed.md   # committed - describes the data
│       └── manifest.json       # committed - file checksums, sizes
```
...
├── README.md                   # Central data catalog
├── tcga/
│   ├── tcga_processed.csv      # gitignored
│   ├── tcga_processed.md       # committed
│   ├── manifest.json           # committed
│   └── download.py             # Script to regenerate data
└── financial/
    ├── stock_data.csv          # gitignored
    ├── stock_data.md           # committed
    └── manifest.json           # committed
```
...
- ✅ `README.md` catalogs
- ✅ Download/regeneration scripts

**Never Commit**:
- ❌ Large CSV/binary data files
- ❌ Model checkpoints (unless tiny)
- ❌ Raw downloaded data

This keeps the repo **git-friendly** while maintaining **agent portability**! 🎯
